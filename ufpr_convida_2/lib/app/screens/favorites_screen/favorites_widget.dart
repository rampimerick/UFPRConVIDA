...
class _FavoritesWidgetState extends State<FavoritesWidget> {
    ...
    return WillPopScope(
      ...
      child: globals.token == ""
          ...
          : Container(
              child: Center(
                child: FutureBuilder(
                  future: getAllFavorites(globals.userName),
                  builder: (BuildContext context, AsyncSnapshot snapshot) {
                    ...
                    if (snapshot.data == null) {
                      ...
                      return Container(
                        child: Text ("Sem eventos favoritos!"),
                      );
                    } else {
                                      ...
                                      trailing: PopupMenuButton<WhyFarther>(
                                        ...
                                        <PopupMenuEntry<WhyFarther>>[
                                          const PopupMenuItem<WhyFarther>(
                                            value: WhyFarther.Favoritar,
                                            child: Text('Favoritar evento'),
                                          ),
                                          const PopupMenuItem<WhyFarther>(
                                            value: WhyFarther.Mapa,
                                            child: Text('Ver no mapa'),
                                          ),
                                          const PopupMenuItem<WhyFarther>(
                                            value: WhyFarther.Link,
                                            child: Text('Link do evento'),
                                          ),
                                        ],
                                      ),
                                      onTap: () {
  ...
  Future<List> getAllFavorites(String idUser) async {
    ...
    http.Response response = await http.get("$_url/users/fav/$idUser", headers: mapHeaders);

    print("-------------------------------------------------------");
    print("Request on: $_url/users/fav/$idUser");
